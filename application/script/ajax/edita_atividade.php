					...
					<div class="modal-body">
						...
						<div class="row form-group">
							...
							<div class="col-sm-4">
                                ...
                                <select name="cli_cod" type="text" class="form-control blockenter" id="cli_cod" <?php echo $desabilita ?>required>
                                    <option value="">--Selecione--</option>
                                    <?php
                                    for ($i = 0; $i < count($cliente); $i++) {
										if($cliente[$i]['cli_cod'] == $result[0]['cli_cod']){
							...
							<div class="col-sm-4">
                                ...
                                <input name="ati_solicitante" type="text" class="form-control blockenter" id="ati_solicitante" style="text-transform:uppercase;" value="<?php echo $result[0]['ati_solicitante']?>" <?php echo $desabilita ?> required></input>
                            </div>

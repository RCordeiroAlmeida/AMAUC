...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <form role="form" action="?module=cadastro&acao=visualiza_cliente" id="MyForm" method="post" enctype="multipart/form-data" name="MyForm">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input name="cli_nome" type="text" class="form-control blockenter" id="cli_nome" value="<?php echo $result[0]['cli_nome']; ?>" style="text-transform:uppercase;" disabled />
                    </div>

                    <div class="col-sm-4">
                        <label class="control-label" for="cli_cnpj">CNPJ:</label>
                        <input name="cli_cnpj" type="text" class="form-control blockenter" id="cli_cnpj" value="<?php echo $result[0]['cli_cnpj']; ?>" disabled />
                    </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-6">
                        ...
                        <input name="cli_tel" type="text" class="form-control blockenter" id="cli_tel" value="<?php echo $result[0]['cli_tel']; ?>" disabled />
                    </div>
                    <div class="col-sm-6">
                        <label class="control-label" for="cli_mail">E-mail:</label>
                        <input name="cli_mail" type="text" class="form-control blockenter" id="cli_mail" value="<?php echo $result[0]['cli_mail']; ?>" disabled />
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-4">
                        ...
                        <input name="cli_endereco" type="text" class="form-control blockenter" id="cli_endereco" value="<?php echo $result[0]['cli_endereco']; ?>" disabled />
                    </div>
                    <div class="col-sm-1">
                        <label class="control-label" for="cli_nro_endereco">Nº:</label>
                        <input name="cli_nro_endereco" type="text" class="form-control blockenter" id="cli_nro_endereco" value="<?php echo $result[0]['cli_nro_endereco']; ?>" disabled />
                    </div>
                    <div class="col-sm-2">
                        <label class="control-label" for="cli_bairro">Bairro:</label>
                        <input name="cli_bairro" type="text" class="form-control blockenter" id="cli_bairro" value="<?php echo $result[0]['cli_bairro']; ?>" disabled />
                    </div>
                    <div class="col-sm-2">
                        <label class="control-label" for="cli_cep">CEP:</label>
                        <input name="cli_cep" type="text" class="form-control blockenter" id="cli_cep" value="<?php echo $result[0]['cli_cep']; ?>" disabled />
                    </div>
                    <div class="col-sm-3">

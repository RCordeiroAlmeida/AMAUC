...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-9 col-xs-8">
        ...
        <ol class="breadcrumb">
            <li>
                <a href="?module=cadastro&acao=lista_cliente">Tipo de Agendamento</a>
            </li>
            <li class="active">
                <strong>Novo</strong>
            </li>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <form role="form" action="?module=cadastro&acao=grava_tipoAge" id="MyForm" method="post" enctype="multipart/form-data" name="MyForm">

                <div class="row form-group">
                    <div class="col-sm-12">
                        <label class="control-label" for="agt_descricao">Tipo:</label>
                        <input name="agt_descricao" type="text" class="form-control blockenter" id="agt_descricao" style="text-transform:uppercase;" required />
                    </div>
                </div>
            </form>
        </div>

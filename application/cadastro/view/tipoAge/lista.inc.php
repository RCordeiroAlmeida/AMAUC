<?php
    ...
    $sql = "SELECT * FROM agenda_tipo WHERE agt_situacao = 1";
    $ati = $data->find('dynamic', $sql);

    $sql = "SELECT * FROM agenda_tipo WHERE agt_situacao = 0";
...
<script>
    ...
    switch ($_GET[ms]) {
        ...
        case 3:
            echo 'toastr.success("Cliente excluido com sucesso", "Excluido!");';
            break;
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-6 col-xs-6">
        ...
        <ol class="breadcrumb">
            <li class="active">
                <strong>Tipo Agendamento</strong>
            </li>
        </ol>
    </div>
    ...
    <div class="col-lg-6 col-xs-6" style="text-align:right;">
        <br /><br />
        <a href="?module=cadastro&acao=novo_tipoAge" class="btn btn-primary" style="height: 34px;">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:80px;">Tipo Agendamento</th>
                                    ...
                                    <tbody>
                                        ...
                                        for ($i = 0; $i < count($ati); $i++) {
                                            echo '
                                            <tr>
                                                <td>' . str_pad($ati[$i]['agt_cod'], 4, '0', STR_PAD_LEFT) . '</td>
                                                <td>' . $ati[$i]['agt_descricao'] . '</td>
                                                <td>';
                                                    if($_SESSION['amauc_userPermissao']==1){
                                                        echo'
                                                            <a href="#" onclick="nextPage(\'?module=cadastro&acao=edita_tipoAge\', ' . $ati[$i]['agt_cod'] . ')">
                                                            <span class="fa-stack">
                                                                <i class="fa fa-square fa-stack-2x"></i>
                                                                <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
                                                            </span>
                                                            </a>
                                                            <a href="#" onClick=\'inativar("' . $ati[$i]['atp_cod'] . '", "' . $ati[$i]['agt_descricao'] . '");\' title="Inativar Tipo de Agendamento" style="text-decoration:none;">
                                                            <span class="fa-stack">
                                                                <i class="fa fa-square fa-stack-2x"></i>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        for ($i = 0; $i < count($ina); $i++) {
                                            ...
                                            <tr>
                                                <td>' . $ina[$i]['agt_cod'] . '</td>
                                                <td>' . $ina[$i]['agt_descricao'] . '</td>
                                            ';
                                            if($_SESSION['amauc_userPermissao'] == 1){

                                                echo'
                                                    <td>
                                                        <a href="#" onClick=\'ativar("' . $ina[$i]['agt_cod'] . '", "' . $ina[$i]['agt_descricao'] . '");\' title="Ativar Tipo Atendimento" style="text-decoration:none;">
                                                            <span class="fa-stack">
                                                                <i class="fa fa-square fa-stack-2x"></i>

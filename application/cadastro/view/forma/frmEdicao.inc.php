...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-9 col-xs-8">
        ...
        <ol class="breadcrumb">
            <li>
                <a href="?module=cadastro&acao=lista_forma">Forma de Atendimento</a>
            </li>
            <li class="active">
                <strong>Novo</strong>
            </li>
            ...
            <form role="form" action="?module=cadastro&acao=update'_forma" id="MyForm" method="post" enctype="multipart/form-data" name="MyForm">
                ...
                <div class="row form-group">
                    <div class="col-sm-12">
                        ...
                        <input name="afr_descricao" type="text" class="form-control blockenter" id="afr_descricao" style="text-transform:uppercase;" value="<?php echo $result[0]['afr_descricao']?>" required />
                    </div>
                </div>
            </form>
        </div>

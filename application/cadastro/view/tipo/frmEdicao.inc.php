<?php
    ...
    $sql =  "SELECT * FROM atividade_tipo WHERE atp_cod = ".$_POST['param_0'];
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <form role="form" action="?module=cadastro&acao=update_tipo" id="MyForm" method="post" enctype="multipart/form-data" name="MyForm">
                <input type="hidden" name="atp_cod" value="<?php echo $result[0]['atp_cod']?>">
                <div class="row form-group">
                    <div class="col-sm-12">
                        <label class="control-label" for="atp_descricao">Tipo:</label>
                        <input name="atp_descricao" type="text" class="form-control blockenter" id="atp_descricao" style="text-transform:uppercase;" value="<?php echo $result[0]['atp_descricao'] ?>" required />
                    </div>
                </div>
            </form>
        </div>
